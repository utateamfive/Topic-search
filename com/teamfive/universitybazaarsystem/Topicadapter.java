...
public class Topicadapter extends FirebaseRecyclerAdapter<TopicRecycler, Topicadapter.topicViewHolder>{

    private OnItemClickListener clickListener;
    public Topicadapter(@NonNull FirebaseRecyclerOptions<TopicRecycler> options)
    {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull topicViewHolder holder, int position, @NonNull TopicRecycler instance)
    {
